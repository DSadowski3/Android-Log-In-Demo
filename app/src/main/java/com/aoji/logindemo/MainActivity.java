...
public class MainActivity extends AppCompatActivity {
    ...
    private void populateText() {
        User user = RESRServiceApplicaiton.getInstance().getUser();
    ...
    public void clickUpdateButton(View view) {
        if(mPasswordText.getText().toString().trim().length()>=5) {
            ...
            Toast.makeText(this, R.string.error_passoword_lenght, Toast.LENGTH_LONG).show();
        }
    }
    ...
    private class UserInfoTask extends ActivityWebServiceTask {
        ...
        public boolean performRequest() {
            ...
            contentValues.put(Constants.ACCESS_TOKEN,
                    RESRServiceApplicaiton.getInstance().getAccessToken());
    ...
    private class UserEditTask extends ActivityWebServiceTask {
        ...
        public boolean performRequest() {
            ...
            urlValues.put(Constants.ACCESS_TOKEN, RESRServiceApplicaiton.getInstance().getAccessToken());
    ...
    private class UserDeleteTask extends ActivityWebServiceTask {
        ...
        public boolean performRequest() {
            ...
            if(!hasError(obj)) {
                RESRServiceApplicaiton.getInstance().setUser(null);
                return true;
            }
